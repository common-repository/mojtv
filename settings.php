<div class="wrap">
    ...
    <form method="post" action="options.php"> 
        ...
        <table class="form-table">  
            ...
            <tr valign="top">
                <th scope="row"><label for="mojtv_setting_target">Prikaži u:</label></th>
                <td>
                	<select name="mojtv_setting_target" id="mojtv_setting_target">
                  	<option value="1"<?php echo ( get_option('mojtv_setting_target') == 1 ? ' selected' : '' ) ?>>Istom prozoru</option>
                    <option value="2"<?php echo ( get_option('mojtv_setting_target') == 2 ? ' selected' : '' ) ?>>Novom prozoru</option>
                  </select>
               	</td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="mojtv_setting_refresh">Prikaži prije koliko je sadržaj osvježen:</label></th>
                <td>
                	<select name="mojtv_setting_refresh" id="mojtv_setting_refresh">
                  	<option value="1"<?php echo ( get_option('mojtv_setting_refresh') == 1 ? ' selected' : '' ) ?>>Ne</option>
                    <option value="2"<?php echo ( get_option('mojtv_setting_refresh') == 2 ? ' selected' : '' ) ?>>Da</option>
                  </select>
               	</td>
            </tr>
        </table>
